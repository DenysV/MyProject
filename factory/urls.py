...
urlpatterns = [
    ...
    url(r'^projects/$', views.projects_back, name = 'projects_back'),
    url(r'^project/(?P<pk>\d+)/tareas/$', views.index1, name = 'index1'),
    url(r'^tarea/(?P<pk>\d+)/horas/$', views.tarea_detail, name = 'tarea_detail'),
    url(r'^tarea/(?P<pk>\d+)/horas/$', views.tarea, name = 'tarea'),
    #url(r'^project/(?P<pk>\d+)/tareas/$', views.index1, name = 'index1'),
